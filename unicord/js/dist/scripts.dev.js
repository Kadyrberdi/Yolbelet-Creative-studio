...
(function ($) {
  $(document).ready(function () {
    ...
    $(".navigation-menu a").each(function (i) {
      if (i != 0) {
        $("#hover-audio").clone().attr("id", "hover-audio" + i).appendTo($(this).parent());
      }
    ...
    $("#hover-audio").attr("id", "hover-audio0"); // SANDWICH MENU AUDIO
